...
const { registerValidation, loginValidation, refreshTokenValidation, otpValidation,passwordResetValidation, otpResendValidation } = require('../../validators/authValidator');
