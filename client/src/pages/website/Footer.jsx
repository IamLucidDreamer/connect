            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="javascript:void(0)"
                    className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
                ...
                <p className="text-base text-body-color ">
                  &copy; 2024 Alumns. All rights reserved.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset="1" stop-color="#C4C4C4" stop-opacity="0.02" />
                </linearGradient>
              </defs>
            </svg>
          </span>
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stop-color="#4f46e5" stop-opacity="0.31" />
