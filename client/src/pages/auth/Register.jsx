...
const Register = () => {
  ...
  return (
    <div className="w-full flex items-center justify-between">
      <div className="min-h-screen w-1/2 2xl:w-2/3 bg-indigo-600 relative hidden lg:block">
        <span className="absolute -top-20 -left-32">
          <svg
            width="475"
            height="475"
            viewBox="0 0 75 75"
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#c4c4c4" stopOpacity="0.02" />
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#ffffff" stopOpacity="0.31" />
                <stop offset="1" stopColor="#C4C4C4" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </span>
        <h1 className=" text-right mb-5 text-2xl font-semibold !leading-[1.208] sm:text-[42px] lg:text-[40px] xl:text-5xl absolute bottom-0 right-10 text-white">
          Welcome <br /> Back
        </h1>
      </div>
        <div className="container mx-auto lg:w-1/2 2xl:w-1/3">
          <div className="flex flex-wrap p-4 sm:p-8 md:p-12">
            <div className="w-full px-4">
                    ...
                    <Form>
                      ...
                      <div className="mb-10">
                        <button
                          ...
                          className="rounded-lg bg-indigo-600 px-7 py-3 text-base font-medium text-white hover:bg-opacity-90 flex items-center justify-center w-full"
                        >
                          Sign Up
                        </button>
                      </div>
                ...
                <a
                  href="javascript:void(0)"
                  className="inline-block text-base text-indigo-600 hover:underline"
                >
                  Forget Password ?
                </a>
